                ...
                {loading ? (
                  ...
                  <Link to={`/blog/${featuredPost.slug}`} className={styles.featuredPostLink}>
                    <motion.div
                      ...
                      className={`${styles.featuredPost} ${hoverStyles.cardHover} group`}
                    >
                      ...
                      <div className={styles.featuredContent}>
                        ...
                        <h2 className={`${styles.featuredTitle} ${hoverStyles.glitchEffect} group-hover:text-white`}>
                          {featuredPost.title}
                        </h2>
                        <p className={styles.featuredExcerpt}>{featuredPost.excerpt}</p>
                        <span className={`${styles.readMore} ${hoverStyles.linkHover}`}>Read Article →</span>
                      </div>
                    </motion.div>
                  </Link>
                )}
                    ...
                    <div className={styles.headerTextGroup}>
                      ...
                      <div className={styles.searchSection}>
                        <input
                          ...
                          className={`${styles.searchInput} ${hoverStyles.focusState}`}
                        />
                        <div className={styles.searchFilters}>
                          <select
                            value={selectedCategory}
                            onChange={(e) => handleCategoryChange(e.target.value)}
                            className={`${styles.filterLabel} ${hoverStyles.focusState} ${hoverStyles.buttonHover}`}
                          >
                      ...
                      paginatedPosts.map((post, index) => (
                        ...
                        >
                          <motion.article
                            ...
                            className={`${styles.postCard} ${hoverStyles.cardHover} group`}
                            data-even={index % 2 === 0}
                          >
                  ...
                  {totalPages > 1 && (
                    <div className={styles.paginationContainer}>
                      <button
                        ...
                        className={`${styles.paginationButton} ${hoverStyles.buttonHover} ${hoverStyles.focusState} ${hoverStyles.microInteraction} ${hoverStyles.arcadeButton}`}
                      >
                        Previous
                      </button>
                      {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                        <button
                          ...
                          className={`${styles.paginationButton} ${hoverStyles.buttonHover} ${hoverStyles.focusState} ${hoverStyles.microInteraction} ${hoverStyles.arcadeButton} ${
                            currentPage === page ? `${styles.paginationButtonActive} ${hoverStyles.pulseEffect}` : ''
                          }`}
                        >
                          {page}
                        </button>
